...
static __inline void idct_ap922_row(short *b, const int *w)
{
	...
	b[0] = (short)((a0+b0+((1<<10)))>>11);
	b[1] = (short)((a1+b1+((1<<10)))>>11);
	b[2] = (short)((a2+b2+((1<<10)))>>11);
	b[3] = (short)((a3+b3+((1<<10)))>>11);
	b[4] = (short)((a3-b3+((1<<10)))>>11);
	b[5] = (short)((a2-b2+((1<<10)))>>11);
	b[6] = (short)((a1-b1+((1<<10)))>>11);
	b[7] = (short)((a0-b0+((1<<10)))>>11);
}
...
static __inline void idct_ap922_col(short *b)
{
	...
	b[0*8] = (short)((t0+t7+((1<<5)))>>6);
	b[1*8] = (short)((t1+t6+((1<<5)))>>6);
	b[2*8] = (short)((t2+t5+((1<<5)-1))>>6);
	b[3*8] = (short)((t3+t4+((1<<5)-1))>>6);
	b[4*8] = (short)((t3-t4+((1<<5)-1))>>6);
	b[5*8] = (short)((t2-t5+((1<<5)-1))>>6);
	b[6*8] = (short)((t1-t6+((1<<5)))>>6);
	b[7*8] = (short)((t0-t7+((1<<5)))>>6);
}
